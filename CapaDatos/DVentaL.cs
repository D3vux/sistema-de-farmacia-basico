   ...
   public  class DVentaL
    {
        ...
        public int obtenerID()
        {
            ...
            comando.CommandText = "Select max(IdMedicamento)as idMax From VentaM";
        ...
        public void insertarL(string laboratorio,  string fechaVencimiento)
        {
            int IdMedicamento = obtenerID();
            comando.Connection = cxn.AbrirConexion();
            comando.CommandText = "INSERT INTO VentaL(IdMedicamento,Laboratorio,  FechaVencimiento)VALUES(@IdMedicamento, @laboratorio,  @fechaVencimiento);";
